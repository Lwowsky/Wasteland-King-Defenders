...
import { getFarmById, getGameProfile, getUserFarms, getUserProfile, normalizeUserRole, saveSignedInUser } from '../services/user-db.js?v=076';
import {
  canManageRegion,
...
import { listRegionCycleArchiveD1, publishRegionTableSnapshot, readFullRegionCycleArchiveD1, readRegionCycleArchiveD1, readRegionFormSettings as readRegionFormSettingsD1 } from '../services/region-table-cache.js?v=076';
import { makePublicShareUrl } from '../core/share-links.js?v=076';
...
async function restoreArchiveCycleToActiveD1() {
  ...
  try {
    ...
    const publishResult = await publishRegionTableSnapshot(currentUser, {
      ...
      settings,
      rows: result.rows,
      actorAccess: actorAccessForCurrentRegion()
    });
