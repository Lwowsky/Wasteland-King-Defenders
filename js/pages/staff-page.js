...
const STAFF_CACHE_BUILD = 'v046-row-edit-access-ticket';
...
const STAFF_TOOL_MODULES = {
  'region-table': './region-table-page.js?v=081',
  'region-settings': './region-settings-page.js?v=081',
  'action-log': './action-log-page.js?v=081'
};
