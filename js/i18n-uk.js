...
(function(){
  ...
  "panels": {
    ...
    "media": {
      ...
      "lead": "Три короткі відео: від першого запуску до готового плану. Перше відео вже додано, інші можна замінити пізніше.",
      "comingSoon": "Скоро",
      "videos": [
        {
          ...
          "copy": "Показує основний шлях: від відкриття сайту до імпорту списку і підготовки даних."
        },
        {
          "badge": "Скоро",
          "kicker": "Буде додано",
          "title": "2. Редактор гравців",
          "copy": "Як виправляти гравців, альянси, марш, ралі, тір, зміну і дублікати."
        },
        {
          "badge": "Скоро",
          "kicker": "Буде додано",
          "title": "3. Турелі + фінальний план",
          "copy": "Як поставити капітанів, заповнити турелі, перевірити резерв і експортувати PNG/TXT."
        }
      ]
    }
  }
