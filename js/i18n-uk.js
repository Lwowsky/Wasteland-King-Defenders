...
(function(){
  ...
  "intro": "Порядок: імпорт списку, регіони й 1–4 зміни, перевірка гравців, капітани, заповнення турелей, резерв і фінальний план.",
  "tab_import": "Імпорт",
  "tab_players": "Гравці",
  "tab_turrets": "Турелі",
  ...
  "panels": {
    ...
    "players": {
      "eyebrow": "2. Гравці",
      "title": "Перевір і відредагуй список",
      "lead": "Тут краще виправити дані до планування.",
      "steps": [
        {
          "title": "Фільтри",
          "purpose": "Пошук і перевірка",
          "copy": "Фільтруй за роллю, зміною, статусом або тіром. «Показати всі дані» використовуй тільки для додаткових колонок."
        },
        {
          "title": "Ручний гравець",
          "purpose": "Додати або змінити одного гравця",
          "copy": "Можна вручну додати гравця, змінити марш/тір/зміну/готовність капітана або видалити ручного гравця."
        },
        {
          "title": "Розміщення",
          "purpose": "Картки змін",
      ...
      "side": [
        {
          "title": "Ручні дані",
          "text": "Ручні гравці лишаються після оновлення сторінки, але можуть очиститись при новому імпорті Excel."
        },
        {
          "title": "Зміни",
          "text": "Сайт підтримує до чотирьох змін, якщо вони ввімкнені в регіонах."
        }
      ],
      "noteTitle": "Перевір перед застосуванням",
      "noteText": "Помилки в марші, тірі або зміні погіршують автоматичний розподіл."
    },
    "turrets": {
      "eyebrow": "3. Турелі",
