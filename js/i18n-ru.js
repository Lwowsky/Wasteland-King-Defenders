...
(function(){
  ...
  "intro": "Порядок: импорт списка, регионы и 1–4 смены, проверка игроков, капитаны, заполнение турелей, резерв и финальный план.",
  "tab_import": "Импорт",
  "tab_players": "Игроки",
  "tab_turrets": "Турели",
  ...
  "panels": {
    ...
    "players": {
      "eyebrow": "2. Игроки",
      "title": "Проверь и измени список",
      "lead": "Исправь данные до планирования.",
      "steps": [
        {
          "title": "Фильтры",
          "purpose": "Поиск и проверка",
          "copy": "Фильтруй по роли, смене, статусу или тиру. «Показать все данные» используй для дополнительных колонок."
        },
        {
          "title": "Ручной игрок",
          "purpose": "Добавить или изменить игрока",
          "copy": "Можно вручную добавить игрока, изменить марш/тир/смену/готовность капитана или удалить ручного игрока."
        },
        {
          "title": "Размещение",
          "purpose": "Карточки смен",
          "copy": "Колонка показывает, где игрок стоит в каждой смене или что он в резерве."
        }
      ],
      "side": [
        {
          "title": "Ручные данные",
          "text": "Ручные игроки сохраняются после обновления страницы."
        },
        {
          "title": "Смены",
          "text": "Поддерживается до четырёх смен, если они включены в регионах."
        }
      ],
      "noteTitle": "Проверка",
      "noteText": "Ошибки в марше, тире или смене ухудшат автозаполнение."
    },
    "turrets": {
      "eyebrow": "3. Турели",
