...
(function(){
  ...
  "panels": {
    ...
    "media": {
      ...
      "lead": "Три коротких видео: от первого запуска до готового плана. Первое видео уже добавлено, остальные можно заменить позже.",
      "comingSoon": "Скоро",
      "videos": [
        {
        ...
        {
          "badge": "Скоро",
          "kicker": "Будет добавлено",
          "title": "2. Редактор игроков",
          "copy": "Как исправлять игроков, альянсы, марш, ралли, тир, смену и дубликаты."
        },
        {
          "badge": "Скоро",
          "kicker": "Будет добавлено",
          "title": "3. Турели + финальный план",
          "copy": "Как поставить капитанов, заполнить турели, проверить резерв и экспортировать PNG/TXT."
        }
      ]
    }
  }
