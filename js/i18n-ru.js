...
(function(){
  ...
  "panels": {
    ...
    "media": {
      ...
      "lead": "Четыре коротких видео: быстрый старт, импорт с таблицей игроков, дубликаты/редактор и турели с финальным планом.",
      "comingSoon": "Скоро",
      "videos": [
        {
          "embed": "https://www.youtube.com/embed/YRzMlLhmqGw",
          "kicker": "Начни здесь",
          "title": "1. Быстрый старт + импорт",
          "copy": "Показывает основной путь: открыть сайт, импортировать список и подготовить данные."
        },
        {
          "embed": "https://www.youtube.com/embed/nZry69HYoEo",
          "kicker": "Импорт",
          "title": "2. Импорт и таблица игроков",
          "copy": "Как загрузить список, проверить колонки, применить импорт и посмотреть результат в таблице игроков."
        },
        {
          "embed": "https://www.youtube.com/embed/ZMzpJZygYJI",
          "kicker": "Редактор",
          "title": "3. Дубликаты и редактор игроков",
          "copy": "Как найти повторяющиеся ники, оставить правильную запись, удалить лишнее и исправить игроков в редакторе."
        },
        {
          "embed": "https://www.youtube.com/embed/JFVfcQQOGkg",
          "kicker": "Финальный план",
          "title": "4. Турели, PNG и TXT",
          "copy": "Как делать списки в турелях, проверять финальный план, скачивать PNG-картинку и TXT-план."
        }
      ]
    }
  }
