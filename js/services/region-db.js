...
import { readCache, writeCache, removeCache } from './local-cache.js?v=081';
import { trackReads, trackWrites, trackDeletes } from './usage-tracker.js?v=081';
import {
  getUserProfile,
  getFarmById,
  getGameProfile,
...
async function actionLogCacheModule() {
  return import('./action-log-cache.js?v=081');
}
...
async function rotateRegionPublicSharesForNewCycle(user, region, actorAccess = null) {
  try {
    const mod = await import('./region-table-cache.js?v=081');
...
async function readFinalPlanFromD1Cache(code, options = {}) {
  try {
    const mod = await import('./final-plan-cache.js?v=081');
