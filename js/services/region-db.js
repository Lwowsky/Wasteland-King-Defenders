...
import { readCache, writeCache, removeCache } from './local-cache.js?v=126';
import { trackReads, trackWrites, trackDeletes } from './usage-tracker.js?v=126';
import {
  getUserProfile,
  getFarmById,
  getGameProfile,
