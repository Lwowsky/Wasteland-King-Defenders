...
import { mirrorPublicStatsPlayer } from './public-stats-cache.js?v=143';
import {
...
} from './notifications-d1.js?v=143';
...
async function writeAdminCountersDoc(db, firestoreMod, counters = {}) {
  const payload = { ...emptyAdminCounters(), ...(counters || {}), updatedAt: firestoreMod.serverTimestamp(), updatedAtMs: Date.now(), source: 'admin-counters-v143' };
